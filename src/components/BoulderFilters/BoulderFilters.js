    ...
    return (
        <div className={"filter"}>
            ...
            <ul className={"filter__items filter-items"}>
                {data.map((item, index) => {
                    return (
                        <li key={index} className={"filter-items__item"} onClick={() => {

                            let current = currentFilters.filter(currentFilter => currentFilter.id !== id)
...
const BoulderFilters = ({filters, setFilters, globalFilter, setGlobalFilter}) => {
