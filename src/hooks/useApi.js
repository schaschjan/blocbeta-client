...
export const api = {
    token: null,
    requestPasswordReset: async (data) => await axios.post(getUri('/request-reset', false), data),
    checkPasswordResetHash: async (hash) => await axios.get(getUri(`/reset/${hash}`, false)),
    resetPassword: async (hash, data) => await axios.post(getUri(`/reset/${hash}`, false), data),
    me: {
